      ...
      <div className="bg-white dark:bg-[#141413] rounded-2xl shadow-xl shadow-black/5 dark:shadow-black/40 p-6 sm:p-8 w-full max-w-2xl border border-black/[0.06] dark:border-white/[0.08] relative valyou-fade-up">
          ...
          {roles.map((role) => {
            ...
            return (
              <button
                ...
                className={`relative flex flex-col items-center text-center p-5 sm:p-6 rounded-xl border-2 transition-all duration-200 ${
                  isSelected
        ...
        <div className="flex flex-col-reverse sm:flex-row gap-3">
          ...
          <button
            disabled={!selected}
            onClick={() => router.push("/map")}
            className={`flex-1 py-3 rounded-lg font-semibold text-sm transition-all flex items-center justify-center gap-2 group ${
              selected
